...
| [H' : context [?X] |- context [if ?X then _ else _]] => rewrite H' /=
| [|- context [let (X,Y) := ?Z in _]] => destruct Z as [X Y]
| [|- context [if ?X then _ else _]] => case_eq X
| [|- _ -> _] => intros| [|- (_, _) = (_,_)] => apply pair_eq
| [H : (_, _) = (_,_) |- _] => inversion H; clear H
| [|- _ /\ _] => split| [|- context [_ && _]] => apply (introT andP)
...
| [H : context [_ /\ _] |- _] => apply (introT andP) in H; destruct_boolhyp H end); repeat rewrite -> in_Imfset_eq.
